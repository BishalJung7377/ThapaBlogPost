...
export declare class LightboxComponent implements OnInit, AfterViewInit, OnDestroy, OnInit {
    ...
    private _windowRef;
    private rotate;
    constructor(_elemRef: ElementRef, _rendererRef: Renderer2, _lightboxEvent: LightboxEvent, _lightboxElem: ElementRef, _lightboxWindowRef: LightboxWindowRef, _http: HttpClient, _fileSaverService: FileSaverService, _sanitizer: DomSanitizer, _documentRef: any);
    ngOnInit(): void;
